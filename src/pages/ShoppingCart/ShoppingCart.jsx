...
import { OrderingStage, OrderItem, RelatedItem, SauceItem, PromoCode, SumOrder, PagginationButtons, Footer, ModalOrderForm } from "components";
        ...
        <div>
            ...
            <div className={style.wrapper}>
                ...
                <div className={style.carousel}>
                    <button className={style.pagginationArrow}><MdOutlineArrowBackIosNew /></button>
                    <div className={style.carousel}>
                        <RelatedItem
                            image={FourChease}
                            description="Домашнаяя паста феттуччине, сливочный соус, креветки, трюфельное масло, черный перец, пармезан.350 г"
                    ...
                    <button className={style.pagginationArrow}><MdOutlineArrowForwardIos /></button>
                </div>
